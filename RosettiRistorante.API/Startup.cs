    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            const string connectionString =
                @"Server=.\SQLEXPRESS;Database=RosettiDatabase;Trusted_Connection=True;ConnectRetryCount=0";
